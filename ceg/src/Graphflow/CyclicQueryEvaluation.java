    ...
    public static void main(String[] args) throws Exception {
        ...
        if (method.contains("acyclic")
            ...
            for (int i = 0; i < queries.size(); ++i) {
                ...
                estimations = catalogue.cyclicEstimation(query, method, randomSampling, allEst, trueCard, catLen);
        ...
        watch.stop();
        double totalTime = watch.getNanoTime() / 1e9;
        resultWriter.write(String.valueOf(totalTime) + "\n");
        resultWriter.close();
        System.out.println("\nEstimating: " + totalTime + " sec");
    }
}
